...
echo '</TD></tr>';
echo '<tr><td>Password</td><td>:</td><td><table cellpadding=0 cellspacing=0><tr><td>';
//for adding new user
...
echo '<TR>';
echo '<TD><TABLE><tr><td style=width:100px>Email Address</td><td>:</td><td>';
echo TextInput($staff['EMAIL'],'staff[EMAIL]','','size=25 maxlength=100 id=email class=cell_floating');
echo '</TD></tr><tr><td style=width:100px>Phone Number</td><td>:</td><td>';
